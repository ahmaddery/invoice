...
<!-- konfigurasi tampilan untuk welcome user yang register melalui google-->

<!DOCTYPE html><html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><script src="chrome-extension://eppiocemhmnlbhjplcgkofciiegomcon/libs/extend-native-history-api.js"></script><script src="chrome-extension://eppiocemhmnlbhjplcgkofciiegomcon/libs/requests.js"></script><head>
  ...
  <body style="background-color:#f3f3f5;" __processed_f3bc858a-6f92-46e9-9bae-e499e67880eb__="true">
    <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Hallo, {{ $user->name }}! Selamat Datang Di Invoice Genrator</div>
    <div style="background-color:#f3f3f5;">
      ...
      <![endif]-->
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:24px;font-weight:400;line-height:30px;text-align:left;color:#ffffff;">
                          <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: normal;">Hallo, {{ $user->name }}! Selamat Datang Di Invoice Generator</h1>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#ffffff;">
                          <p style="margin-bottom: 0;">Kami sangat senang menyambut Anda sebagai anggota baru komunitas kami. Akun <a href="#" style="text-decoration: none; color: white;">Anda telah berhasil dibuat. Dengan Google</a>. ntuk memastikan pengalaman Anda tetap aman dan nyaman, berikut beberapa hal yang perlu diperhatikan: </p><br>
                          Selalu pastikan Anda login dari perangkat yang tepercaya.<br>
                            Jika mendeteksi aktivitas mencurigakan, segera tinjau akun Anda.<br>
                            Kami mendeteksi login dari perangkat baru untuk akun {{ $user->name }}! Anda. Jika ini adalah Anda, silakan abaikan pesan ini.<br>
                            <strong>Email:</strong> {{ $user->email }}<br>
                        <strong>Terdaftar Pada:</strong> {{ \Carbon\Carbon::now()->toFormattedDateString() }}<br>
                        </div>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                          <tbody><tr>
                            <td align="center" bgcolor="#2e58ff" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#2e58ff;" valign="middle">
                              <a href="{{ url('/dashboard') }}" style="display: inline-block; background: #2e58ff; color: white; font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; line-height: 30px; margin: 0; text-decoration: none; text-transform: none; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank"> Dashboard </a>
                            </td>
                          </tr>
                        </tbody></table>
                      </td>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#ffffff;">
                          <p style="margin-bottom: 0;">Butuh Bantuan? </strong><br>
                            Tim dukungan kami selalu siap membantu. Jika Anda memiliki pertanyaan atau membutuhkan bantuan, jangan ragu untuk menghubungi kami.
                     :)</p>
                        </div>
                      </td>
                    </tr>
            ...
            <![endif]-->
                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                    <tbody><tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:center;color:#93999f;">&copy; {{ date('Y') }} Our Application. All rights reserved. <br /> Email: <a class="footer-link" href="#" style="color: #2e58ff; text-decoration: none;">care@ahmaddery.com</a> <br /> Web: <a class="footer-link" href="#" style="color: #2e58ff; text-decoration: none;">www.ahmaddery.com</a></div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
